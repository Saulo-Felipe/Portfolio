...
export const projects: ProjectType[] = [
  {
    title: "Flor de Mandacaru",
    about: "Plataforma de controle de gestão de reservas. Possui controle de reservas com base em IP, sistema de autenticação, controle de acesso baseado em permissões, integração de pagamento (PIX, cartões de crédito e débito), além do uso de webhooks e envio automatizado de emails.",
    github: "https://pousadaflordemandacaru.com.br",
    preview: "https://pousadaflordemandacaru.com.br",
    imgUrl: "/flor-de-mandacaru.png",
    languages: ["NextJS", "Typescript", "NodeJS", "NextJS", "PostgreSQL", "PrismaJS", "Tailwind", "HTML5", "CSS3"],
    tags: [
      { content: "Full Stack" }
    ]
  },
